...
import com.example.adminservice.Sekretaris.Input_Kegiatan;
...
public class Admin_Kegiatan_Remaja extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_kegiatan_masjid);
    ...
    private void initcontent() {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Admin_Kegiatan_Remaja.this, MainActivityAdmin.class)
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Konfigurasi.URL_GET_KEGIATAN,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            KegiatanAdapter adapter = new KegiatanAdapter(Admin_Kegiatan_Remaja.this, ListKegiatan, Admin_Kegiatan_Remaja.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Admin_Kegiatan_Remaja.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(Admin_Kegiatan_Remaja.this, Ferivikasi_Kegiatan.class);
